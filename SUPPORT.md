...
Thanks for using layer! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/marcosci/layer/issues/new).
...
requests](https://github.com/marcosci/layer/issues) to make sure the bug
